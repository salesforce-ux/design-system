...
- Styling Hooks
  ...
  - For this release, the new hooks are scoped exclusively to a predefined list of Lightning Web Component primitives, Copilot elements, side panel wrapper, and a catch-all class. (This is set to change in the future.)
