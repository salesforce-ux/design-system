...
import { UtilityIcon } from '../../../components/icons/base/example';
import { Button } from '../';
...
export const examples = [
  ...
  },
  {
    ...
    element: (
      <Button
        leftIcon={<UtilityIcon size="x-small" symbol="check" useCurrentColor />}
        variant="success"
      >
        Brand Button
      </Button>
  ...
  },
  {
    ...
    element: (
      <Button
        rightIcon={
          <UtilityIcon size="x-small" symbol="close" useCurrentColor />
        }
        variant="destructive"
      >
        Brand Button
  ...
  {
    id: 'button-icon-both',
    label: 'With Icon Left and Right',
    element: (
      <Button
        leftIcon={<UtilityIcon size="x-small" symbol="check" useCurrentColor />}
        rightIcon={
          <UtilityIcon size="x-small" symbol="download" useCurrentColor />
        }
        variant="neutral"
      >
        Brand Button
