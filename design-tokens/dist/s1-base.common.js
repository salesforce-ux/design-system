module.exports = {
  ...
  // Maximum height for action overflow menu so that it's not full-screen for tablet initially.
  ...
  // Maximum width for action icons in action bar.
  maxWidthActionBar: "600px",
  // Max-width of an action bar item
