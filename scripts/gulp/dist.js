...
// Helper to write an autogeneration warning to a stylesheet
let writeAutoGenerationWarning = content => {
  let message = `
/*
    ...
    .pipe(
      gulpTap(function(file) {
        file.contents = Buffer.from(
          writeAutoGenerationWarning(file.contents.toString())
        );
      })
    )
...
export const minifyCss = () =>
  gulp
    .src([distPath('assets/styles/*.css'), distPath('ui/modules/**/*.css')], {
      base: distPath()
    })
    .pipe(gulp.dest(distPath()))
    .pipe(
