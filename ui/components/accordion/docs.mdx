...
<StyleApiTable name="accordion" type="component" />
...
<CodeView>{getDisplayElementById(Base.states, 'section-one-open')}</CodeView>

### Section 2 - Open

<CodeView>{getDisplayElementById(Base.states, 'section-two-open')}</CodeView>

### Section 3 - Open

<CodeView>{getDisplayElementById(Base.states, 'section-three-open')}</CodeView>
