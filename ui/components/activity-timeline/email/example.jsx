...
export let ActivityTimelineItem = props =>
  <div className="slds-timeline__item">
    ...
    >
      <MediaObject
        className="slds-timeline__media slds-timeline__media--email"
      ...
      >
        ...
        <ul className="slds-list--horizontal slds-wrap">
          <li className="slds-truncate_container--50 slds-m-right--large slds-grid">
            ...
            <span
              className="slds-text-body--small slds-m-left--xx-small slds-truncate"
            ...
            <span className="slds-no-flex slds-text-body--small"> + 44 more</span>
          </li>
