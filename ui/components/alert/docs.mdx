...
#### Role
Alert notifications should contain <code>role="alert"</code> on the container to signal to assistive technology that they require the user’s immediate attention.
...
#### Assistive Text
Use a span with the class <code>.slds-assistive-text</code> to let the user know what type of notification it is
