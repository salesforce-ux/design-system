...
<CodeView style={getDemoStylesById(AppLauncherExamples.states, 'tooltip')}>
...
<CodeView style={getDemoStylesById(AppLauncherExamples.states, 'grabbed')}>
...
<CodeView style={getDemoStylesById(AppLauncherExamples.states, 'moved')}>
...
<CodeView style={getDemoStylesById(AppLauncherExamples.states, 'dropped')}>
...
<CodeView style={getDemoStylesById(AppLauncherExamples.states, 'search')}>
