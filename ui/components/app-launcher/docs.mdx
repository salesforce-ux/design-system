...
<CodeView isViewport exampleOnly style={{ height: '600px' }}>
  {AppLauncherExamples.default}
</CodeView>
...
<CodeView isViewport style={getDemoStylesById(AppLauncherExamples.states, 'default')}>
...
<CodeView isViewport style={getDemoStylesById(AppLauncherExamples.states, 'tooltip')}>
...
<CodeView isViewport style={getDemoStylesById(AppLauncherExamples.states, 'grabbed')}>
...
<CodeView isViewport style={getDemoStylesById(AppLauncherExamples.states, 'moved')}>
...
<CodeView isViewport style={getDemoStylesById(AppLauncherExamples.states, 'dropped')}>
...
<CodeView isViewport style={getDemoStylesById(AppLauncherExamples.states, 'search')}>
