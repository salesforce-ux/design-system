...
<ColorToken token="BRAND_BACKGROUND_PRIMARY" />
<ColorToken token="BRAND_BACKGROUND_PRIMARY_TRANSPARENT" />
<ColorToken token="BRAND_BACKGROUND_DARK" />
<ColorToken token="BRAND_BACKGROUND_DARK_TRANSPARENT" />
