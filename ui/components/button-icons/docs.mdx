...
<CodeView toggleCode={false}>{getDisplayElementById(Brand.default)}</CodeView>

### Inverse

<CodeView toggleCode={false}>
  <Inverse.Context>{getDisplayElementById(Inverse.default)}</Inverse.Context>
</CodeView>
...
<DisplayGrid>
  ...
  <DisplayColumn>
    ...
    <CodeView toggleCode={false}>
      <BorderedFilled.Context>{getDisplayElementById(BorderedFilled.default)}</BorderedFilled.Context>
    </CodeView>
  </DisplayColumn>
  <DisplayColumn>
