...
<Blockquote type="a11y" header="Accessibility Note">
  ...
  <ul className="slds-list_dotted">
    ...
    <li><code className="doc">aria-pressed</code> is set to <code className="doc">true</code> or <code className="doc">false</code>, depending on its state</li>
  </ul>
</Blockquote>
...
<CodeView toggleCode={true}>
  <Fragment>
    ...
    {getDisplayElementById(Stateful.states, "button-icon-stateful-selected-disabled")}
  </Fragment>
</CodeView>
...
<CodeBlock toggleCode={false}>
  <button>
    <svg className="...slds-button__icon_{size}">
      ...
    </svg>
    ...
  </button>
...
<Example title="Sizes">
  <CodeView toggleCode={true}>
    <React.Fragment>
      <ButtonIcon className="slds-button_icon-border slds-button_icon-small" assistiveText="More options" title="More Options"/>

      <ButtonIcon className="slds-button_icon-border slds-button_icon-x-small" assistiveText="More options" title="More Options"/>

      <ButtonIcon className="slds-button_icon-border slds-button_icon-xx-small" assistiveText="More options" title="More Options"/>
    </React.Fragment>
  </CodeView>
</Example>
...
<CodeBlock toggleCode={false}>
  <button className="slds-button slds-button_icon ..." disabled>...</button>
</CodeBlock>
...
Error button icons are typically used in conjunction with an [error popover](../popovers/?variant=error).
...
<CodeBlock toggleCode={false}>
  <HintParent>
    <button className="slds-button slds-button_icon">
      <svg className="slds-button__icon slds-button__icon_hint">
        ...
      </svg>
      ...
    </button>
