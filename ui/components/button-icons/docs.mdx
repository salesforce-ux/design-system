...
<Example title="Sizes">
  <CodeView toggleCode={true}>
    <React.Fragment>
      <ButtonIcon iconClassName="slds-button__icon_large"/>

      <ButtonIcon iconClassName="slds-button__icon_small"/>

      <ButtonIcon iconClassName="slds-button__icon_x-small"/>
...
<Example title="Sizes">
  <CodeView toggleCode={true}>
    <React.Fragment>
      <ButtonIcon className="slds-button_icon-border slds-button_icon-small"/>

      <ButtonIcon className="slds-button_icon-border slds-button_icon-x-small"/>

      <ButtonIcon className="slds-button_icon-border slds-button_icon-xx-small"/>
    </React.Fragment>
  </CodeView>
</Example>
