...
<CodeView style={{ backgroundColor: '#16325c', padding: '0.5rem' }} toggleCode={false}>
  {getDisplayElementById(ButtonExamples.examples, 'inverse')}
</CodeView>

<MobileNotice docsLink="#Mobile" header="Mobile context changes" />
