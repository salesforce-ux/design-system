...
<Blockquote type="note" header="JavaScript Requirement">
  ...
  <code className="doc">slds-not-selected</code> to{' '}
  <code className="doc">slds-is-selected-clicked</code>. As soon as focus leaves
  the button, use JavaScript to toggle the class from{' '}
  <code className="doc">slds-is-selected-clicked</code> to{' '}
  <code className="doc">slds-is-selected</code>.
</Blockquote>
...
<Blockquote type="note" header="JavaScript Requirement">
  ...
  <code className="doc">slds-is-pressed</code> class on or off, depending on the
