  ...
  <CodeBlock toggleCode={false}>
    ...
    <ul class="slds-carousel__indicators" role="tablist">
      <li class="slds-carousel__indicator" role="presentation">
        <a id="indicator-id-01" class="slds-carousel__indicator-action" href="javascript:void(0);" role="tab" tabindex="-1" aria-selected="false" aria-controls="content-id-01" title="Visit App Exchange tab">
          ...
        </a>
      </li>
      <li class="slds-carousel__indicator" role="presentation">
        <a id="indicator-id-02" class="slds-carousel__indicator-action slds-is-active" href="javascript:void(0);" role="tab" tabindex="0" aria-selected="true" aria-controls="content-id-02" title="Click to Customize tab">
          ...
        </a>
      </li>
    </ul>
...
<Blockquote header="Accessibility" type="a11y">
  A panel becomes visible by toggling the <code class="doc">aria-hidden</code> attribute from <code class="doc">false</code> to <code class="doc">true</code> on the <code class="doc">slds-carousel__panel</code> element. When a panel becomes active, the `tabindex` of the other non-visible panels should be set to -1 while the active panel remains at 0.
</Blockquote>
...
<Blockquote header="Accessibility" type="a11y">
  When that pause button is interacted with, the <code class="doc">aria-pressed</code> role needs to be toggled to <code class="doc">true</code>.
</Blockquote>
