import {CodeView, CodeBlock} from '../../../shared/components/CodeView';
      ...
      <ChatListItem type="outbound">
        <ChatMessage>
          <ChatMessageBody type="outbound">
            Hi Andy, thank you for contacting Amazon Support. Can you please tell me what language you are trying to program on your Amazon Echo?
          </ChatMessageBody>
        </ChatMessage>
      </ChatListItem>
      <ChatListItem type="inbound">
      ...
      <ChatListItem type="outbound">
        <ChatMessage>
          <ChatMessageBody
            ...
            timeStamp="5:15 PM"
          >
            Sorry ot hear that. Let me see what I can do about this.
          </ChatMessageBody>
        </ChatMessage>
      </ChatListItem>
    </ChatList>
...
Chat messages are comprised of the message text, and message meta data including the persons name and time at which the message was sent. Chat message come in 3 forms:
...
<Blockquote
  ...
  type="a11y"
>
  Each message meta data wrapper has <code className="doc">aria-label</code> added, which we can use to form more human sounding messages as they arrive, <b>"Hi, my Alexa only speaks French said Taylor Watson-Rice at 4:59 PM"</b>. A screen reader, when <code className="doc">aria-label</code> is applied to an element, will only announce the contents of the label, not the text content held in it.
</Blockquote>
        ...
        <ChatListItem type="outbound">
          <ChatMessage>
            <ChatMessageBody
              ...
              timeStamp="4:59 PM"
            >
              Hi Taylor, thank you for contacting Amazon Support. Can you please tell me what language you are trying to program on your Amazon Echo? <a href="javascript:void(0)">http://www/amazon.com</a>
            </ChatMessageBody>
          </ChatMessage>
        </ChatListItem>
      </ChatList>
        ...
        <ChatListItem type="outbound">
          <ChatMessage>
            <ChatMessageBody
              ...
              timeStamp="4:59 PM"
            >
              So sorry to hear that. Let me transfer you to a more technical support member. Thank you for your patients. Have you tried visiting our help site?
            </ChatMessageBody>
          </ChatMessage>
        </ChatListItem>
      </ChatList>
        ...
        <ChatListItem type="outbound">
          <ChatMessage>
            <ChatMessageBody
              ...
              timeStamp="5:15 PM"
            >
              Sorry ot hear that. Let me transfer you to a more technical support member. Thank you for your patients!
            </ChatMessageBody>
          </ChatMessage>
        </ChatListItem>
        <ChatListItem type="event">
