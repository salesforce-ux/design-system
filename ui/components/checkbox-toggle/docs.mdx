...
import * as CheckboxToggleExamples from './base/example';
...
<CodeView exampleOnly>
  {getDisplayElementById(CheckboxToggleExamples.states, 'checkbox-toggle-checked')}
</CodeView>
...
<CodeView>
  {getDisplayElementById(CheckboxToggleExamples.states, 'checkbox-toggle-disabled')}
</CodeView>

#### Right to Left

<CodeView>
  {getDisplayElementById(CheckboxToggleExamples.states, 'checkbox-toggle-rtl')}
</CodeView>
