...
<CodeView frameOnly>{CheckboxToggleExamples.default}</CodeView>

## Base

<CodeView>{CheckboxToggleExamples.default}</CodeView>
...
<StylingHooksTable name="checkbox-toggle" type="component" />
