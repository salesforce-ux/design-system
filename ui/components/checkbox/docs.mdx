...
<CodeView exampleOnly>{CheckboxExamples.default}</CodeView>
...
<CodeView frameOnly frameTitle="Example mobile styles for checkboxes">{CheckboxExamples.default}</CodeView>
...
<CodeView>{CheckboxExamples.default}</CodeView>
...
<CodeView>{CheckboxFormElementExamples.default}</CodeView>
