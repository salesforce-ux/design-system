...
<Example title="Combobox - Base">
  <CodeView style={{maxWidth: '40rem', height: '15rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-1" snapshot={Snapshot.ObjectOptions} type="plain" count={8} visualSelection />}
...
<Example title="Combobox - Handling focus">
  ...
  <CodeView style={{maxWidth: '40rem', height: '15rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-4" snapshot={Snapshot.ObjectOptions} type="plain" count={8} visualSelection />}
      dropdownType="listbox"
      isOpen
      hasFocus
    />
...
<Example title="Combobox - Handling focus with a keyboard">
  ...
  <CodeView style={{maxWidth: '40rem', height: '5rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-4" snapshot={Snapshot.ObjectOptionsFocused} type="plain" count={8} visualSelection />}
      dropdownType="listbox"
      hasFocus
    />
  </CodeView>
...
<Example title="Combobox - Autocomplete">
  ...
  <CodeView style={{maxWidth: '40rem', height: '12rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-9" snapshot={Snapshot.PlainOptions} type="plain" count={3} />}
      dropdownType="listbox"
      hasInteractions
    />
  </CodeView>
...
<Example title="Combobox - Autocomplete - Displaying Options">
  ...
  <CodeView style={{maxWidth: '40rem', height: '12rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-10" snapshot={Snapshot.PlainOptions} type="plain" count={3} />}
      dropdownType="listbox"
      isOpen
      hasFocus
    />
...
<Example title="Combobox - Autocomplete - Displaying options based on user input">
  ...
  <CodeView style={{maxWidth: '40rem', height: '12rem'}}>
    <Combobox
      ...
      value="opp"
      dropdown={<Listbox id="listbox-id-11" snapshot={Snapshot.PlainOptionsTypeahead} term="opp" type="plain" count={4} />}
      dropdownType="listbox"
      isOpen
      hasFocus
    />
...
<Example title="Combobox - Autocomplete - Keyboard interactions">
  ...
  <CodeView style={{maxWidth: '40rem', height: '12rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-12" snapshot={Snapshot.PlainOptionsFocused} type="plain" count={3} />}
      dropdownType="listbox"
      aria-activedescendant="option1"
      isOpen
      hasFocus
...
<Example title="Combobox - Autocomplete - Selecting an option">
  ...
  <CodeView style={{maxWidth: '40rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-unique-id-03" snapshot={Snapshot.PlainOptions} type="entity" count={3} />}
      dropdownType="listbox"
      value="GenePoint"
    />
  </CodeView>
...
<Example title="Combobox - Autocomplete - Multiple selections">
  ...
  <CodeView style={{maxWidth: '40rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-13" snapshot={Snapshot.PlainOptions} type="entity" count={3} />}
      dropdownType="listbox"
      hasSelection
...
<Example title="Combobox - Autocomplete - Entity">
  ...
  <CodeView style={{maxWidth: '40rem', height: '10rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-14" snapshot={Snapshot.EntityOptions} type="entity" count={2} />}
      dropdownType="listbox"
      hasInteractions
    />
  </CodeView>
...
<Example title="Combobox - Autocomplete - Entity - Displaying options">
  ...
  <CodeView style={{maxWidth: '40rem', height: '10rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-15" snapshot={Snapshot.EntityOptions} type="entity" count={2} />}
      dropdownType="listbox"
      isOpen
      hasFocus
    />
...
<Example title="Combobox - Autocomplete - Entity - Displaying options based on user input">
  <CodeView style={{maxWidth: '40rem', height: '15rem'}}>
    <Combobox
      ...
      value="salesforce"
      dropdown={<Listbox id="listbox-id-16" snapshot={Snapshot.EntityOptionsTypeahead} term="salesforce" type="entity" count={4} />}
      dropdownType="listbox"
...
<Example title="Combobox - Autocomplete - Entity - Keyboard interactions">
  ...
  <CodeView style={{maxWidth: '40rem', height: '10rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-17" snapshot={Snapshot.EntityOptionsFocused} type="entity" count={2} />}
      dropdownType="listbox"
      aria-activedescendant="option1"
      isOpen
      hasFocus
...
<Example title="Combobox - Autocomplete - Entity - Single selection">
  ...
  <CodeView style={{maxWidth: '40rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-18" snapshot={Snapshot.EntityOptions} type="entity" count={2} />}
      dropdownType="listbox"
      hasSelection
...
<Example title="Combobox - Autocomplete - Entity - Multiple Selection">
  ...
  <CodeView style={{maxWidth: '40rem'}}>
    <Combobox
      ...
      dropdown={<Listbox id="listbox-id-19" snapshot={Snapshot.EntityOptions} type="entity" count={2} />}
      dropdownType="listbox"
      hasSelection
...
<Example title="Combobox - Grouped">
  ...
  <CodeView style={{maxWidth: '40rem', height: '15rem'}}>
    <ComboboxGroup
      ...
      autocomplete
      dropdown={<Listbox id="listbox-id-20" snapshot={Snapshot.EntityOptions} type="entity" count={4} />}
      dropdownType="listbox"
...
<Example title="Combobox - Grouped - User input">
  ...
  <CodeView style={{maxWidth: '40rem', height: '15rem'}}>
    <ComboboxGroup
      ...
      autocomplete
      dropdown={<Listbox id="listbox-id-21" snapshot={Snapshot.EntityOptionsTypeahead} term="salesforce" type="entity" count={4} />}
      dropdownType="listbox"
      value="salesforce"
      isOpen
      hasFocus
...
<Example title="Combobox - Grouped - Selecting options">
  ...
  <CodeView style={{maxWidth: '40rem'}}>
    <ComboboxGroup
      ...
      autocomplete
      dropdown={<Listbox id="listbox-id-22" snapshot={Snapshot.EntityOptions} type="entity" count={4} />}
      dropdownType="listbox"
      hasFocus
...
<Example title="Combobox - Grouped - User inptu with selections made">
  ...
  <CodeView style={{maxWidth: '40rem', height: '15rem'}}>
    <ComboboxGroup
      ...
      autocomplete
      dropdown={<Listbox id="listbox-id-23" snapshot={Snapshot.EntityOptions} type="entity" count={4} />}
      dropdownType="listbox"
      isOpen
      hasFocus
...
<Example title="Combobox - Grouped - Collapsed pills">
  ...
  <CodeView style={{maxWidth: '40rem'}}>
    <ComboboxGroup
      ...
      autocomplete
      dropdown={<Listbox id="listbox-id-24" snapshot={Snapshot.EntityOptions} type="entity" count={4} />}
      dropdownType="listbox"
...
<Example title="Combobox - Grouped - Expanded pills">
  ...
  <CodeView style={{maxWidth: '40rem'}}>
    <ComboboxGroup
      ...
      autocomplete
      dropdown={<Listbox id="listbox-id-25" snapshot={Snapshot.EntityOptions} type="entity" count={4} />}
      dropdownType="listbox"
      hasFocus
...
<Example title="Combobox - Grouped - Scoping text variant">
  ...
  <CodeView style={{maxWidth: '40rem', height: '15rem'}}>
    <ComboboxGroup
      ...
      autocomplete
      dropdown={<Listbox id="listbox-id-26" snapshot={Snapshot.EntityOptions} type="entity" count={2} />}
...
<Example title="Combobox - Grouped - Scoping icon variant - Blurred">
  ...
  <CodeView style={{maxWidth: '40rem'}}>
    <ComboboxGroup
      ...
      autocomplete
      dropdown={<Listbox id="listbox-id-28" snapshot={Snapshot.EntityOptions} type="entity" count={2} />}
      dropdownType="listbox"
...
<Example title="Combobox - Grouped - Scoping icon variant">
  ...
  <CodeView style={{maxWidth: '40rem', height: '15rem'}}>
    <ComboboxGroup
      ...
      autocomplete
      dropdown={<Listbox id="listbox-id-27" snapshot={Snapshot.EntityOptions} type="entity" count={2} />}
      dropdownType="listbox"
...
<li>2. The combobox `<div>` with `class="slds-combobox"` has `aria-haspopup=”dialog”`</li>
<li>3. The dropdown is a dialog with `role="dialog"`</li>
<li>4. The dialog should have an `aria-label` with a value for the dialog's title</li>
<li>5. The combobox has `aria-expanded="false"` when the dialog is closed, and `aria-expanded="true"` when the dialog is open. </li>
</ul>
</Blockquote>
...
Focusing on the input and pressing the `down arrow` opens the dialog and moves focus to the first focusable element.
...
If nothing has been selected yet, the input's value remains "Select an Option" or something similar.
