...
<Blockquote type="a11y" header="Accessibility Requirement">
  ...
  <code>aria-expanded</code> attribute needs to be toggled to{' '}
  <code>true</code>. Set it to{' '}
  <code>false</code> again when the options are hidden.
</Blockquote>

<Blockquote type="a11y" header="Accessibility Note">
  The <code>listbox</code> of options must be an <b>owned</b>{' '}
  child of the <code>combobox</code>. If it cannot be a direct
  child of the <code>combobox</code> element, then{' '}
  <code>aria-owns</code> must be placed on the{' '}
  <code>combobox</code> and point to the ID of the{' '}
  <code>listbox</code> instead.
</Blockquote>
...
<Blockquote type="a11y" header="Accessibility Requirement">
  Update <code>aria-expanded</code> to "true" when the Combobox
  is expanded.
</Blockquote>
...
<Blockquote type="a11y" header="Accessibility Requirement">
  ...
  <code>aria-activedescendant</code> attribute on the{' '}
  <code>input</code> needs to be set to the value of the ID of
  the highlighted option. The highlighted option must also have{' '}
  <code>aria-selected="true"</code>. When no option is
  highlighted, <code>aria-activedescendant</code> must be
  removed.
</Blockquote>
...
<Blockquote type="a11y" header="Accessibility Requirement">
  Update <code>aria-expanded</code> to "false" when the Combobox
  is collapsed.
</Blockquote>
...
<Blockquote type="a11y" header="Accessibility Requirement">
  Be sure to re-set the <code>aria-activedescendant</code>{' '}
...
<Blockquote type="a11y" header="Accessibility Difference">
  ...
  <code>input</code> must have the{' '}
  <code>readonly</code> attribute removed and replaced with{' '}
...
<Blockquote type="a11y" header="Accessibility Requirement">
  When highlighting an option with "faux focus", the{' '}
  <code>aria-activedescendant</code> attribute on the `input`
...
<Blockquote type="a11y" header="Accessibility Requirement">
  ...
  <code>readonly</code> attribute to the text{' '}
  <code>input</code>. Be sure to remove it again when the option
  is cleared.
</Blockquote>
...
<Blockquote type="warning" header="Keep in mind">
  ...
  <code>slds-combobox_addon-start</code> and{' '}
  <code>slds-combobox_addon-end</code> to describe the position
  of the form element.
</Blockquote>

<Blockquote type="a11y" header="Accessibility Requirement">
  Be sure to set <code>aria-controls</code> on the Object
