...
export let ComboboxContainer = props => (
  <div className={classNames('slds-form-element', props.formClassName)}>
    ...
    >
      ...
      <div
        className={classNames(
          'slds-combobox_container vlocity-newport-combobox_container',
          {
        ...
        >
          <div
            className={classNames(
              ...
              {
                'slds-input-has-icon vlocity-newport-input-has-icon vlocity-newport-input-has-icon_left':
                  props.inputIcon === 'left',
                'slds-input-has-icon vlocity-newport-input-has-icon vlocity-newport-input-has-icon_right':
                  props.inputIcon === 'right',
                'slds-input-has-icon vlocity-newport-input-has-icon vlocity-newport-input-has-icon-right':
