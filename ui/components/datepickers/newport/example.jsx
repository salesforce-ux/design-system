...
let DatepickerContainer = props => (
  <div
    ...
    className={classNames(
      'slds-datepicker vlocity-newport-datepicker',
      props.className
    )}
    role="dialog"
  >
...
export let NewportDatePicker = props => (
  <DatepickerContainer className="slds-dropdown slds-dropdown_right">
    <DatepickerHeader />
    <table
...
export default (
  <FormElement
    className="slds-dropdown-trigger slds-dropdown-trigger_click slds-is-open vlocity-newport-dropdown-trigger"
    label="Date"
    inputId={dateInputId}
    inputIcon="right"
    dropdown={<NewportDatePicker todayActive />}
  >
    <NewportInput id={dateInputId} placeholder=" " />
    <ButtonIcon
