...
<CodeView exampleOnly isViewport style={{height: '500px', minWidth: '615px', overflow: 'hidden'}}>
...
<CodeView isViewport style={{height: '500px', minWidth: '615px', overflow: 'hidden'}}>
