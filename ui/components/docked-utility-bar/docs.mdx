...
<CodeView isViewport exampleOnly style={getDemoStylesById(Base.states, 'open')}>
...
## Base
<CodeView isViewport style={getDemoStylesById(Base.states, 'default')}>
...
### Panel open
<CodeView isViewport style={getDemoStylesById(Base.states, 'open')}>
  {getDisplayElementById(Base.states, 'open')}
</CodeView>

### Item has notification
<CodeView isViewport style={getDemoStylesById(Base.states, 'notification')}>
...
<CodeView isViewport style={getDemoStylesById(Base.states, 'pop-out')}>
