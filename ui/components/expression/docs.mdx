...
<Example title="Expression Builder - Condition Added">
  <CodeView>
    <Expression optionSelected="all" resourceIsSelected>
      <ExpressionRow legendText="AND" assistiveText="Condition 2" inputIsDisabled/>
    </Expression>
  </CodeView>
</Example>
...
<Example title="Expression Builder - Error State">
  <CodeView>
    <Expression optionSelected="all" resourceIsSelected>
      <ExpressionRow legendText="AND" assistiveText="Condition 2" errorMessage="This field is required." hasError />
    </Expression>
  </CodeView>
</Example>
...
<Example title="Expression Builder - All Conditions">
  <CodeView>
    <Expression optionSelected="all" resourceIsSelected>
      <ExpressionRow legendText="AND" assistiveText="Condition 2" resourceIsSelected/>
    </Expression>
  </CodeView>
</Example>
...
<Example title="Expression Builder - Any Conditions">
  <CodeView>
    <Expression optionSelected="any" resourceIsSelected>
      <ExpressionRow legendText="OR" assistiveText="Condition 2" resourceIsSelected/>
    </Expression>
  </CodeView>
</Example>
  ...
  <CodeView>
    <Expression optionSelected="all" resourceIsSelected>
      <ExpressionGroup
        ...
        isGroup
      >
        <ExpressionRow assistiveText="Condition 1" isGroup resourceIsSelected/>
        <ExpressionRow legendText="OR" assistiveText="Condition 2" isGroup inputIsDisabled/>
      </ExpressionGroup>
    </Expression>
  </CodeView>
</Example>
...
<Example title="Expression Builder - Custom Logic">
  <CodeView>
    <Expression hasCustomLogic customLogicValue="1 AND 2" legendText="1" optionSelected="custom" resourceIsSelected>
      <ExpressionRow legendText="2" assistiveText="Condition 2" inputIsDisabled/>
    </Expression>
  </CodeView>
</Example>
