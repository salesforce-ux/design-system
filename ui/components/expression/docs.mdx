...
<Blockquote type="a11y" header="Accessibility Requirement">
  ...
  <code className="doc">&lt;div&gt;</code> containing the error message should
  have the <code className="doc">role="alert"</code> attribute applied. This
...
<Blockquote type="a11y" header="Accessibility Requirement">
  ...
  of <code className="doc">aria-describedby</code>. The value of{' '}
  <code className="doc">aria-describedby</code> matches the ID given to the
