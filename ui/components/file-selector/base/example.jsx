...
export let states = [
  ...
  },
  {
    ...
    label: 'Dragover',
    element: <FileSelector files className="slds-file-selector_files" draggover />
  },
  {
    id: 'file-selector-files-draggover-error',
    label: 'Dragover with error',
    element: <FileSelector files className="slds-file-selector_files" draggoverError error />
  }
];
