...
let IntegratedFileSelector = props =>
  <div className={classNames('slds-file-selector slds-file-selector_integrated', props.className)}>
    <div className={classNames('slds-file-selector__dropzone slds-file-selector__dropzone_integrated', props.drag ? 'slds-has-drag' : null, props.draggover ? 'slds-has-drag-over' : null)} aria-hidden="true">
      ...
      <label className="slds-file-selector__body slds-file-selector__body_integrated" htmlFor="file-upload-input-01">
...
export let states = [
  ...
  },
  {
    ...
    element:
      <div className="demo-only" style={{ width: '320px', height: '320px' }}>
        <IntegratedFileSelector className="slds-file-selector_integrated" drag draggover>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
        </IntegratedFileSelector>
      </div>
  },
  {
    ...
    element:
      <div className="demo-only" style={{ width: '320px', height: '320px' }}>
        <IntegratedFileSelector className="slds-file-selector_integrated" drag draggoverError error>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
        </IntegratedFileSelector>
      </div>
  }
