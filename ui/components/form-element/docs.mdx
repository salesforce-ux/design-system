...
<CodeView exampleOnly>
  <FormElement labelContent="Form Label" inputId="form-element-showcase-01" isRequired>
    <Input id="form-element-showcase-01" placeholder="Placeholder Text" required />
  </FormElement>
</CodeView>
