...
<Blockquote type="a11y" header="Accessibility requirement">
  ...
  <code className="doc">aria-describedby</code> attribute to the{' '}
  <code className="doc">&lt;input&gt;</code>. The `aria-describedby` attribute
...
<Blockquote type="a11y" header="Accessibility Requirement">
  ...
  readers that this is a list by adding <code className="doc">role="list"</code>{' '}
  to the <code className="doc">slds-form</code> element. Every column inside of
  each row should get <code className="doc">role="listitem"</code> to identify
