...
<Example title="Form Element - Readonly">
  <CodeView>
    <div className="slds-form-element slds-form-element_small">
...
<Example title="Form Element - Condensed">
  ...
  <CodeView>
    <div className="slds-form" role="list">
      <div className="slds-grid slds-gutters_small">
        <div className="slds-col slds-has-flexi-truncate" role="listitem">
          <FormElement
            formElementClassName="slds-form-element_small slds-form-element_edit slds-hint-parent"
