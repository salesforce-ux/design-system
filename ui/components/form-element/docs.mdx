...
<Example title="Form Element - Record Detail - View Mode">
  <CodeView>
    <RecordDetail snapshot={Snapshot.ObjectFieldTypes} isViewMode direction="stacked" />
  </CodeView>
</Example>
...
<Example title="Form Element - Record Detail - View Mode - Horizontal">
  <CodeView>
    <RecordDetail className="slds-form_horizontal" snapshot={Snapshot.ObjectFieldTypes} isViewMode direction="horizontal" />
  </CodeView>
</Example>
...
<Example title="Form Element - Record Detail - Edit Mode - Horizontal">
  <CodeView>
    <RecordDetail className="slds-form_horizontal" snapshot={Snapshot.ObjectFieldTypes} direction="horizontal" />
  </CodeView>
</Example>
