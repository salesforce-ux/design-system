...
<CodeView exampleOnly style={{ position: 'relative', height: '20.25rem' }}>
  <GlobalHeader
    globalSearch={
      <ComboboxGroup
...
In most scenarios, you will want to fix the global header to the top of the viewport. To achieve this, wrap the global header component in a `<div>` with the classname `slds-global-header_container`.
