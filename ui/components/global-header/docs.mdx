...
<CodeView exampleOnly demoStyles="position: relative; height: 20.25rem;">
  <GlobalHeader
    globalSearch={
      <ComboboxGroup
...
<Example title="base global header">
  <CodeView demoStyles="position: relative; height: 21.25rem;">
    <GlobalHeader
      globalSearch={
        <ComboboxGroup
          id={_.uniqueId('combobox-id-')}
...
<Example title="Global Header Search Default State">
  <CodeView demoStyles="position: relative; height: 3.5rem;">
    <GlobalHeader
      globalSearch={
        <ComboboxGroup
          id={_.uniqueId('combobox-id-')}
...
<Example title="Global Header Search Expanded State">
  <CodeView demoStyles="position: relative; height: 21rem;">
    <GlobalHeader
      globalSearch={
        <ComboboxGroup
          id={_.uniqueId('combobox-id-')}
