...
<Blockquote type="note" header="Note">
  ...
  `use` attribute with the underscore separator as shown on the icon page. For
  example: log_a_call.
</Blockquote>
...
<Blockquote type="note" header="Note">
  You must require SLDS in your application for SVG sprites to work. If you’re
  using Visualforce, see{' '}
  <a href="/platforms/visualforce">the Visualforce tutorial</a>. If you’re using{' '}
  <a href="/platforms/lightning">
