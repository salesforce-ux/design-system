...
<div className="doc lead">
  Icons provide visual context and enhance usability. Read more in the <a href="/guidelines/iconography" title="Iconography Guidelines">Iconography design guideline</a> and for a full list of icons available, visit the <a href="/icons" title="Icons">Icons page</a>.
</div>
...
You must require SLDS in your application for SVG sprites to work. If you’re using Visualforce, see [the Visualforce tutorial](/platforms/visualforce). If you’re using [Lightning components, see this documentation](/platforms/lightning).
...
<Example title="Utility Warning">
  <CodeView>
    <UtilityIcon className="slds-icon-text-success" />
  </CodeView>
</Example>
...
- For [action](/components/icons/#Action) icons, add the `.slds-icon_container_circle` class to the container (`.slds-icon_container`), which changes the background shape to a circle.
- [Doctype](/components/icons/#Doctype) icons have no background color.
- [Standard](/components/icons/#Standard) and [Custom](/components/icons/#Custom) icons have a rounded square shape and use a class on the container for the background color.
- [Utility](/components/icons/#Base) icons have no background color.
