- For [action](/icons/#action) icons, add the `.slds-icon_container--circle` class to the container (`.slds-icon_container`), which changes the background shape to a circle.
