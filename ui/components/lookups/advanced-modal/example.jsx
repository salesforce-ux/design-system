  ...
  <Modal className="slds-modal_large">
    ...
    <ModalContent>
      <div className="slds-lookup" data-select="multi" data-scope="single" data-typeahead="true">
        ...
        <table className="slds-table slds-table_bordered slds-table_cell-buffer slds-no-row-hover" role="listbox">
          <thead>
            <tr>
              <th colSpan="4" scope="col">
                <div className="slds-float_right">
                  <ButtonIcon className="slds-button_icon slds-button_icon-x-small" symbol="filterList" assistiveText="Filter List" title="Filter List" />
                  <ButtonIcon className="slds-button_icon slds-button_icon-x-small" symbol="sort" assistiveText="Sort" title="Sort" />
                </div>
              ...
              <th scope="row">
                <a id="s01" href="javascript:void(0);" role="option">
                  <div className="slds-truncate" title="Acme Landscape">
                    <SvgIcon className="slds-icon slds-icon-standard-account slds-icon_small slds-m-right_x-small" sprite="standard" symbol="account" />
                    Acme Landscape
                  </div>
                </a>
              </th>
