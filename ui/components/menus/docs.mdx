...
<Blockquote type="a11y" header="Accessibility Note">
  If using one of the icons to indicate selection (e.g. checkmarks), be sure to check out the <a href="#Menus-with-Selectable-Items">Menus with Selectable Items</a> docs for the Accessibility implications
</Blockquote>
...
<Blockquote type="a11y" header="Accessibility Note">
  If using one of the icons to indicate selection (e.g. checkmarks), be sure to check out the <a href="#Menus-with-Selectable-Items">Menus with Selectable Items</a> docs
</Blockquote>

<Example title="double icon">
  <CodeView style={{height: '150px'}}>
    <DoubleIcon/>
  </CodeView>
</Example>
...
<Example title="icon left selectable">
  <CodeView style={{height: '150px'}}>
...
<Example title="overflow scrolling">
