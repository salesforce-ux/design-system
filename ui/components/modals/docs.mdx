...
### Full Modal
<CodeView isViewport demoStyles={getDemoStylesById(Base.examples, 'full')}>
  {getDisplayElementById(Base.examples, 'full')}
</CodeView>

### Full Tagline Modal
<CodeView isViewport demoStyles={getDemoStylesById(Base.examples, 'full-tagline')}>
  {getDisplayElementById(Base.examples, 'full-tagline')}
</CodeView>

### Full Headless Modal
<CodeView isViewport demoStyles={getDemoStylesById(Base.examples, 'full-headless')}>
  {getDisplayElementById(Base.examples, 'full-headless')}
</CodeView>

### Full Footless Modal
<CodeView isViewport demoStyles={getDemoStylesById(Base.examples, 'full-footless')}>
  {getDisplayElementById(Base.examples, 'full-footless')}
</CodeView>
