...
<CodeView exampleOnly isViewport demoStyles="height: 640px;">
  {Base.default}
</CodeView>
...
<CodeView frameOnly frameStyles={{ height: '640px' }}>
  {Base.default}
</CodeView>

## Base

<CodeView isViewport demoStyles={getDemoStylesById(Base.examples, 'default')}>
...
<StyleApiTable name="modals" type="component" />
