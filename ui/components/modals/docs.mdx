...
<CodeView exampleOnly isViewport style={{ height: '640px' }}>
  { Base.default }
</CodeView>
...
## Base
<CodeView isViewport style={getDemoStylesById(Base.examples, 'default')}>
...
### Taglines
<CodeView isViewport style={getDemoStylesById(Base.examples, 'taglines')}>
{ getDisplayElementById(Base.examples, 'taglines') }
</CodeView>

### Headless
<CodeView isViewport style={getDemoStylesById(Base.examples, 'headless')}>
{ getDisplayElementById(Base.examples, 'headless') }
</CodeView>

### Footless
<CodeView isViewport style={getDemoStylesById(Base.examples, 'footless')}>
{ getDisplayElementById(Base.examples, 'footless') }
</CodeView>

### Directional
<CodeView isViewport style={getDemoStylesById(Base.examples, 'directional')}>
{ getDisplayElementById(Base.examples, 'directional') }
</CodeView>

### Small Modal
<CodeView isViewport style={getDemoStylesById(Base.examples, 'small')}>
{ getDisplayElementById(Base.examples, 'small') }
</CodeView>

### Medium Modal
<CodeView isViewport style={getDemoStylesById(Base.examples, 'medium')}>
  { getDisplayElementById(Base.examples, 'medium') }
</CodeView>

### Large Modal
<CodeView isViewport style={getDemoStylesById(Base.examples, 'large')}>
