...
## About Notifications
The body of the notification is a clickable region that will prompt an additional browser tab with that record loaded and dismiss the notification. It is also dismissible by clicking the X icon.
