  ...
  <div className="demo-only" style={{width: '300px'}}>
    <div className="slds-page-header slds-page-header_vertical">
      <div className="slds-grid slds-grid_vertical">
        <div>
          <MediaObject flavor="center" figureLeft={image} className="slds-no-space slds-has-divider_bottom-space">
      ...
      <ul className="slds-list_vertical-space-medium slds-m-left_xx-small">
        <li className="slds-item">
          ...
          <div className="slds-text-body_regular" title="Description that demonstrates truncation with a long text field">
        ...
        <li className="slds-item">
          <div className="slds-text-title slds-m-bottom_xx-small">
            <button className="slds-button slds-text-link_reset" aria-haspopup="true">
              Field 4 (3)
              <SvgIcon className="slds-button__icon slds-button__icon_small" sprite="utility" symbol="down" />
            </button>
          </div>
        ...
        <li className="slds-item">
          <div className="slds-text-title slds-truncate slds-m-bottom_xx-small" title="Field 7">Field 7</div>
          <div className="slds-text-body_regular" title="Description">
            Description
          </div>
        </li>
