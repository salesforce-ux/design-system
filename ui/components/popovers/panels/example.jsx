...
const iconOpportunity = (
  <span className="slds-icon_container slds-icon-standard-opportunity">
    <SvgIcon className="slds-icon slds-icon_small" sprite="standard" symbol="opportunity" />
    <span className="slds-assistive-text">Opportunities</span>
  </span>
);
const iconCases = (
  <span className="slds-icon_container slds-icon-standard-case">
    <SvgIcon className="slds-icon slds-icon_small" sprite="standard" symbol="case" />
    <span className="slds-assistive-text">Cases</span>
  </span>
);

const ViewAll = () =>
  <dd className="slds-m-top_x-small slds-text-align_right"><a href="javascript:void(0);" title="View all Opportunities">View All</a></dd>;
    ...
    <div className="slds-popover__header">
      ...
      <header className="slds-media slds-media_center slds-m-bottom_small">
        ...
        <div className="slds-media__body">
          <h2 className="slds-text-heading_medium slds-hyphenate" id="panel-heading-id"><a href="javascript:void(0);">Tesla Motors</a></h2>
        </div>
      </header>
      ...
      <footer className="slds-grid slds-wrap slds-grid_pull-padded">
        ...
        <div className="slds-p-horizontal_small slds-size_1-of-2 slds-p-bottom_x-small">
          <dl>
            <dt><p className="slds-text-title_caps slds-truncate" title="Billing Address">Billing Address</p></dt>
            <dd>
        ...
        <div className="slds-p-horizontal_small slds-size_1-of-2 slds-p-bottom_x-small">
          <dl>
            <dt><p className="slds-text-title_caps slds-truncate" title="Phone">Phone</p></dt>
        ...
        <div className="slds-p-horizontal_small slds-size_1-of-2 slds-p-bottom_x-small">
          <dl>
            <dt><p className="slds-text-title_caps slds-truncate" title="Website">Website</p></dt>
        ...
        <div className="slds-p-horizontal_small slds-size_1-of-2 slds-p-bottom_x-small">
          <dl>
            <dt><p className="slds-text-title_caps slds-truncate" title="Account Owner">Account Owner</p></dt>
