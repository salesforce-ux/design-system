...
<Blockquote type="a11y" header="Accessibility Requirements">
  <p>
    ...
    in the <code>&lt;span&gt;</code> with class <code>slds-assistive-text</code>, such as <code>Step 1 -
    Active</code>.
  </p>
</Blockquote>
...
<Blockquote type="a11y" header="Accessibility Requirements">
  <p>
    ...
    text in the <code>&lt;span&gt;</code> with class <code>slds-assistive-text</code>, such as <code>Step 2 -
    Completed</code>.
  </p>
</Blockquote>
...
<Blockquote type="a11y" header="Accessibility Requirements">
  <p>
    ...
    text in the <code>&lt;span&gt;</code> with class <code>slds-assistive-text</code>, such as <code>Step 3 -
    Error</code>.
  </p>
</Blockquote>
