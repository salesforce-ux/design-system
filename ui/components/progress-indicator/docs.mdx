...
As the percentage of completion changes, be sure to update the `aria-valuenow` property on the `<div>` with the class `slds-progress-bar`, as well as the `slds-assistive-text` class on the `<span>`.
...
<Blockquote type="a11y" header="Accessibility Requirements">
  ...
  in the <code>&lt;span&gt;</code> with class <code>slds-assistive-text</code>, such as "Step 1 -
  Active".
</Blockquote>
...
<Blockquote type="a11y" header="Accessibility Requirements">
  ...
  text in the <code>&lt;span&gt;</code> with class <code>slds-assistive-text</code>, such as "Step 2 -
  Completed".
</Blockquote>
...
<Blockquote type="a11y" header="Accessibility Requirements">
  ...
  text in the <code>&lt;span&gt;</code> with class <code>slds-assistive-text</code>, such as "Step 3 -
  Error".
</Blockquote>
...
### Multi-line Step Titles

The vertical progress indicator also supports multi-line step descriptions.
