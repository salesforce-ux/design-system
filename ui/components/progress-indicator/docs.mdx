...
<Blockquote type="a11y" header="Accessibility Requirements">
  ...
  <code className="doc">aria-describedby</code> attribute, whose value should be
  the <code className="doc">id</code> of the associated tooltip.
</Blockquote>
