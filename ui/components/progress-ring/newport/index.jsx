...
class NewportProgressRing extends Component {
    ...
    return (
      <div
        className={classNames(
          'slds-progress-ring vlocity-newport-progress-ring',
          stateClass
        )}
      >
        <div
...
NewportProgressRing.propTypes = {
  percent: React.PropTypes.number
};

NewportProgressRing.defaultProps = {
  percent: 55
};

export default NewportProgressRing;
