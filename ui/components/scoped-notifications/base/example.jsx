...
export default (
  <ScopedNoti iconClassName="slds-icon-text-default" />
);
...
export let examples = [
  {
    ...
    label: 'Light Theme',
    element:
      <ScopedNoti className="slds-scoped-notification_light" iconClassName="slds-icon-text-default" />
  },
  {
    id: 'dark-theme',
    label: 'Dark theme',
    element:
    <ScopedNoti className="slds-scoped-notification_dark" />
  }
];
