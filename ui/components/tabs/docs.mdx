...
<CodeView demoStyles="height: 100px;">{SubTabs.default}</CodeView>
...
<Blockquote header="Accessibility" type="a11y">
  ...
  <br />
  <br />
  1. The <code>title</code> attribute and <code>aria-label</code> on the element that displays the red
