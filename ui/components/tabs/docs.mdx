...
import MobileTabs, { MobileTabGroup, NestedMobileStacked } from './MobileTabs';
...
To use vertical tabs, check out the [Vertical Tabs](../components/vertical-tabs) component
