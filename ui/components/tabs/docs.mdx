...
Tabs come with an option of having an inbuilt header based on the size modifiers: default, medium, and large.
...
### Invisible Accessible Header

<Example title="Tabs with Invisible Heading">
  <CodeView demoStyles="height: 200px;">
    <TabsWithHeading showHeader={false}/>
  </CodeView>
</Example>
