...
Subtabs are used to provide an additional level of navigation below the [Global Navigation](/components/global-navigation). Use these tabs when users need to work across multiple sub-pages within a single navigation item.
