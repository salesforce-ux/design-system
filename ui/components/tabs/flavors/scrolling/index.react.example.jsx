    ...
    <div className="slds-tabs--default">
      <Scroller>
        ...
        <div className="slds-tab__scroll-controls">
          <ButtonIcon className="slds-button--icon-border" symbol="chevronleft" aria-hidden="true" tabIndex="-1" assistiveText="Scroll tabs left" title="Scroll tabs left" />
          <ButtonIcon className="slds-button--icon-border" symbol="chevronright" aria-hidden="true" tabIndex="-1" assistiveText="Scroll tabs right" title="Scroll tabs right" />
        </div>
      </Scroller>
