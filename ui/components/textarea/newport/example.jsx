...
const textareaId = 'newport-textarea-id-01';
...
export let NewportTextarea = props => (
  <textarea
    ...
    className={classNames(
      'slds-textarea vlocity-newport-textarea',
      props.className
    )}
  ...
  },
  {
    ...
    element: (
      <FormElement className="slds-has-error">
        ...
        <FormElementControl>
          <NewportTextarea required aria-describedby="error-01" />
        </FormElementControl>
