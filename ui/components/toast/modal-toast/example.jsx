    ...
    <Modal className="slds-modal_large">
      <ModalHeader>
        <div className="slds-notify_container">
          <div className="slds-notify slds-notify_toast slds-theme_error" role="alert">
            ...
            <div className="slds-notify__content slds-grid">
              <SvgIcon className="slds-icon slds-icon_small slds-m-right_small slds-col slds-no-flex" sprite="utility" symbol="warning" />
