...
<CodeView exampleOnly isViewport style={getDemoStylesById(WelcomeMat.examples, 'with-completed-tiles')}>
...
<CodeView isViewport style={getDemoStylesById(WelcomeMat.examples, 'default')}>
...
<CodeView isViewport style={getDemoStylesById(WelcomeMat.examples, 'with-completed-tiles')}>
  {getDisplayElementById(WelcomeMat.examples, "with-completed-tiles")}
</CodeView>
...
<CodeView isViewport style={getDemoStylesById(WelcomeMatTrailhead.examples, 'trailhead-complete')}>
...
<CodeView isViewport style={getDemoStylesById(InfoOnly.examples, 'default')}>
...
<CodeView isViewport style={getDemoStylesById(Splash.examples, 'default')}>
