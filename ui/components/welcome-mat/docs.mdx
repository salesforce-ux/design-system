...
## With Content Overflow and Scrolling

The Welcome Mat supports content overflow scrolling, to adapt to a number of content scenarios.

<Example title="Welcome Mat Partially Completed Steps">
  <CodeView>
    <Context>
      {baseExamples[2].element}
    </Context>
  </CodeView>
</Example>
