...
<CodeView style={{ height: '200px' }}>
  {getDisplayElementById(Base.states, 'vertical-zero')}
</CodeView>

#### 25% complete

<CodeView style={{ height: '200px' }}>
  {getDisplayElementById(Base.states, 'vertical-25')}
</CodeView>

#### 50% complete

<CodeView style={{ height: '200px' }}>
  {getDisplayElementById(Base.states, 'vertical-50')}
</CodeView>

#### 75% complete

<CodeView style={{ height: '200px' }}>
  {getDisplayElementById(Base.states, 'vertical-75')}
</CodeView>

#### 100% complete

<CodeView style={{ height: '200px' }}>
  {getDisplayElementById(Base.states, 'vertical-100')}
</CodeView>
