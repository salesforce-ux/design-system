...
export default (
  <div>
    ...
    <p>Notifications should contain <code>role="alert"</code> on the container to signal to assistive technology that they require the user&rsquo;s immediate attention. Use a span with <code>.slds-assistive-text</code> to let the user know what type of notification it is.</p>
  </div>
);
