...
Our sizing classes set widths in percentages. This will keep your layout fluid to the width of your <code>slds-grid</code> container.
</Blockquote>
...
The default <code>slds-gutters</code> is subject to change over time but is a great way to ensure when we upgrade, you upgrade.
</Blockquote>
