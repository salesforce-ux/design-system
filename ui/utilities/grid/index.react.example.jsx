...
export let examples = [
  ...
  },
  {
    ...
    <div className="slds-grid slds-grid--pull-padded-medium">
      <div className="slds-col slds-p-horizontal--medium"></div>
      <div className="slds-col slds-p-horizontal--medium"></div>
    </div>,
  ...
  },
  {
    ...
    <div className="slds-grid slds-wrap slds-grid--pull-padded">
      <div className="slds-p-horizontal--small slds-size--1-of-1"></div>
      <div className="slds-p-horizontal--small slds-size--1-of-2 slds-medium-size--5-of-6 slds-large-size--8-of-12"></div>
      <div className="slds-p-horizontal--small slds-size--1-of-2 slds-medium-size--1-of-6 slds-large-size--4-of-12"></div>
      <div className="slds-p-horizontal--small slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-3"></div>
      <div className="slds-p-horizontal--small slds-size--1-of-1 slds-medium-size--1-of-2 slds-large-size--1-of-3"></div>
      <div className="slds-p-horizontal--small slds-size--1-of-1 slds-large-size--1-of-3">
        <div className="slds-grid slds-wrap slds-grid--pull-padded">
          <div className="slds-p-horizontal--small slds-size--1-of-2 slds-medium-size--1-of-1 slds-large-size--1-of-2"></div>
          <div className="slds-p-horizontal--small slds-size--1-of-2 slds-medium-size--1-of-1 slds-large-size--1-of-2"></div>
        </div>
      </div>
    </div>,
  ...
  },
  {
    ...
    element:
    <div className="slds-grid">
      <div className="slds-align-top"></div>
      <div className="slds-align-middle"></div>
      <div className="slds-align-bottom"></div>
    </div>,
  ...
  },
  {
    ...
    <div className="slds-grid">
      ...
      <div></div>
      <div></div>
      <div className="slds-col--bump-left"></div>
      <div></div>
    </div>,
  ...
  },
  {
    ...
    element:
    <div className="slds-grid">
      <div className="slds-order--2 slds-medium-order--1 slds-large-order--3"></div>
      <div className="slds-order--3 slds-medium-order--2 slds-large-order--2"></div>
      <div className="slds-order--1 slds-medium-order--3 slds-large-order--1"></div>
    </div>,
  ...
  },
  {
    ...
    <div className="slds-grid slds-grid--vertical">
      <div className="slds-container--small"></div>
      <div className="slds-container--medium"></div>
      <div className="slds-container--large"></div>
      <div className="slds-container--x-large"></div>
      <div className="slds-container--fluid"></div>
    </div>,
